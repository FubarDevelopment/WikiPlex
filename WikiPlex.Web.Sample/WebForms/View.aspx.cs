    ...
    public partial class View : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["v"]) && int.TryParse(Request.QueryString["v"], out version))
            {
                ...
                if (wikiContent == null)
                    Response.Redirect(ResolveClientUrl("~/WebForms/View.aspx?p=" + HttpUtility.UrlEncode(slug)));
            }
            else
        ...
        protected void BindPageHistoryItem(object sender, RepeaterItemEventArgs e)
        {
            ...
            else
            {
                ...
                versionLink.NavigateUrl = ResolveClientUrl("~/WebForms/View.aspx?p=" + HttpUtility.UrlEncode(wikiContent.Title.Slug) + "&v=" + historyItem.Version);
